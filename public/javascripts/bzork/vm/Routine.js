...
bzork.vm.Routine.prototype.getNumLocals = function() {
  return this._machine.getUint8(this._addr);
};

bzork.vm.Routine.prototype.getLocalValues = function() {
...
bzork.vm.Routine.prototype.getFirstInstructionAddr = function() {
  if (this._machine.getZcodeVersion() >= 5)
    return this._addr + 1;
  else
